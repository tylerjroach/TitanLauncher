...
package com.tylerjroach.titan.backup.nano;
...
public interface BackupProtos {
  ...
  public static final class Key extends
    ...
    public Key clear() {
      type = com.tylerjroach.titan.backup.nano.BackupProtos.Key.FAVORITE;
      name = "";
      id = 0L;
      checksum = 0L;
      cachedSize = -1;
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case com.tylerjroach.titan.backup.nano.BackupProtos.Key.FAVORITE:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Key.SCREEN:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Key.ICON:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Key.WIDGET:
                this.type = value;
                break;
            }
            break;
  ...
  public static final class Journal extends
    ...
    public com.tylerjroach.titan.backup.nano.BackupProtos.Key[] key;

    // optional int32 backup_version = 6 [default = 1];
    public int backupVersion;

    // optional .launcher_backup.DeviceProfieData profile = 7;
    public com.tylerjroach.titan.backup.nano.BackupProtos.DeviceProfieData profile;
    ...
    public Journal clear() {
      ...
      bytes = 0L;
      rows = 0;
      key = com.tylerjroach.titan.backup.nano.BackupProtos.Key.emptyArray();
      backupVersion = 1;
      profile = null;
      cachedSize = -1;
      return this;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.key != null && this.key.length > 0) {
        for (int i = 0; i < this.key.length; i++) {
          com.tylerjroach.titan.backup.nano.BackupProtos.Key element = this.key[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            com.tylerjroach.titan.backup.nano.BackupProtos.Key[] newArray =
                new com.tylerjroach.titan.backup.nano.BackupProtos.Key[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.key, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new com.tylerjroach.titan.backup.nano.BackupProtos.Key();
          ...
          case 58: {
            if (this.profile == null) {
              this.profile = new com.tylerjroach.titan.backup.nano.BackupProtos.DeviceProfieData();
            }
  ...
  public static final class Favorite extends
    ...
    public Favorite clear() {
      ...
      targetType = com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_NONE;
      rank = 0;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.targetType != com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_NONE) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 152: {
            int value = input.readInt32();
            switch (value) {
              case com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_NONE:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_PHONE:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_MESSENGER:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_EMAIL:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_BROWSER:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_GALLERY:
              case com.tylerjroach.titan.backup.nano.BackupProtos.Favorite.TARGET_CAMERA:
  ...
  public static final class Widget extends
    ...
    public com.tylerjroach.titan.backup.nano.BackupProtos.Resource icon;

    // optional .launcher_backup.Resource preview = 5;
    public com.tylerjroach.titan.backup.nano.BackupProtos.Resource preview;
    ...
    public Widget mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 34: {
            if (this.icon == null) {
              this.icon = new com.tylerjroach.titan.backup.nano.BackupProtos.Resource();
            }
          ...
          case 42: {
            if (this.preview == null) {
              this.preview = new com.tylerjroach.titan.backup.nano.BackupProtos.Resource();
            }
