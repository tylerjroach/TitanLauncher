...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.tylerjroach.titan.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "com.tylerjroach.titan.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.tylerjroach.titan.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "com.tylerjroach.titan.compat.PackageInstallerCompatV16.queue"));
}
